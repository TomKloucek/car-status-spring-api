...
public class LowBatteryCapacityDecorator extends BaseDecorator {
    public LowBatteryCapacityDecorator(Notifier n) {
        super(n);
    }

    @Override
    public String sendMessage(String message) {
        return super.sendMessage(message + "<p color='red'>Low battery capacity</p>");
    }
}
